CREATE OR REPLACE PACKAGE  QPAP_CEnt1530PkG IS
/*****************************************************************************/
/* システム名    ：高島屋クレジットシステム                                  */
/* 業務名        ：社員融資管理                                              */
/* モジュール名  ：QPAP_CEnt1530PkG                                          */
/* 機能          ：残高履歴テーブル登録処理（賞与控除）                      */
/* 作成日        ：2010/02/25                                                */
/* 作成者        ：NBC saitoh                                                */
/*****************************************************************************/
/******************************************************************************************************************/
...
/* 残高履歴テーブル登録処理（賞与控除） */
PROCEDURE QPAP_ZNDK_SYKJTURK (
				InChaNetID	IN	CHAR,	--ネットＩＤ
				InChaJobID	IN	CHAR);	--ジョブＩＤ

END QPAP_CEnt1530PkG;
/
SHOW ERROR
...
/* ２  ボディー                                                              */
/*****************************************************************************/
CREATE OR REPLACE PACKAGE BODY QPAP_CEnt1530PkG IS


/*****************************************************************************/
/* モジュール名  ：QPAP_CEnt1530PkG.QPAP_ZNDK_SYKJTURK                       */
/* 機能          ：残高履歴テーブル登録処理（賞与控除）                      */
/*****************************************************************************/
PROCEDURE	QPAP_ZNDK_SYKJTURK (
				InChaNetID	IN	CHAR,	--ネットＩＤ
...
IS
	...
	module		VARCHAR2(40)	:= 'QPAP_CEnt1530PkG.QPAP_ZNDK_SYKJTURK';
