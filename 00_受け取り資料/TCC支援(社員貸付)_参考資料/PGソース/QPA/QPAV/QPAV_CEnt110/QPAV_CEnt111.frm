...
Begin VB.Form frmQPAV_CEnt111 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin FPSpread.vaSpread sprList 
            ...
            SpreadDesigner  =   "QPAV_CEnt111.frx":0000
            VisibleCols     =   500
            VisibleRows     =   500
         End
      End
   ...
   End
End
Attribute VB_Name = "frmQPAV_CEnt111"
...
Private Sub cmdExec_Click()
 ...
 Dim S          As Variant
    ...
    If Len(Trim$(strSyainCd)) = 7 Then
        frmQPAV_CEnt110.txtSyainCd(1).Text = Mid(strSyainCd, 1, 7)
    ElseIf Len(Trim$(strSyainCd)) = 8 Then
        frmQPAV_CEnt110.txtSyainCd(0).Text = Mid(strSyainCd, 1, 1)
        frmQPAV_CEnt110.txtSyainCd(1).Text = Mid(strSyainCd, 2, 7)
    Else
        frmQPAV_CEnt110.txtSyainCd(0).Text = " "
        frmQPAV_CEnt110.txtSyainCd(1).Text = " "
    End If
