...
Begin VB.Form frmQPAV_CEnt180 
   BorderStyle     =   1  '固定(実線)
   Caption         =   "精算店マスタメンテナンス"
   ClientHeight    =   8580
   ClientLeft      =   180
   ClientTop       =   1095
   ClientWidth     =   14385
   ...
   Begin VB.Frame Frame1 
      ...
      Begin FPSpread.vaSpread vaSpread1 
         ...
         SpreadDesigner  =   "QPAV_CEnt180.frx":0000
         UserResize      =   0
         VisibleCols     =   500
         VisibleRows     =   500
      End
   ...
   End
End
Attribute VB_Name = "frmQPAV_CEnt180"
...
'*******************************************************************************************
    ...
    frmQPAV_CEnt181.cmdTouroku.Caption = cmdExec(Index).Caption
    Me.Enabled = False      'タブ移動制御
    frmQPAV_CEnt181.Show 1
    Me.Enabled = True
    ...
    If bInit_Flg = True Then
        ...
        If Not gblnCreateOracleSession() Then
            ...
            Call QSAV_SysErr.subSysErr(gcstrPrjName, gstrCommandLine(1) _
                                    ...
                                    , "精算店マスタメンテナンス (" & gstrCommandLine(8) & ") " _
