...
Option Explicit
 Public Const gcstrPrjName = "QPAV_CEnt510"
...
On Error GoTo errgblnHaita
    ...
    odbDatabase.Parameters.Add "InStrSikibetu", "510", ORAPARM_INPUT                      '識別コード
...
'エラー処理
    ...
    If odbDatabase.LastServerErr >= 20000 Then   'Msg = 他の端末で処理中です。再度実行して下さい
        frmQPAV_CEnt510.lblMsg.Caption = "WHOE11 " & gstrGetCodeMeisyo(odbDatabase, "E11", "WHO")
...
On Error GoTo errgsubUnLock
    ...
    odbDatabase.Parameters.Add "strSikibetu", "510", ORAPARM_INPUT                  '識別
