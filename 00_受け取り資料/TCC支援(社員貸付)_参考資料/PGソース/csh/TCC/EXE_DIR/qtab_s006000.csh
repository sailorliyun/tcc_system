...
setenv JOB_ID       $1                         # ジョブ名
setenv JOBNET_ID    $2                          # ジョブネット名
set    LOGFILE    = $USER_LOG_DIR/${JOB_ID}.log        # ログファイル名
set    LOGWRITE   = $EXE_DIR/QUAJ_MSGLOG.BAT           # ログ出力モジュール
setenv USERKEY     'PINHULFT'                          # ユーザキー
set    KINOU      = 'ＰＩＮ対応履歴データ移動'         # 機能名
set    QT_DATA_DIR  = $3                               # ＰＩＮ対応履歴データ保存先
set    QT_BACK_DIR  = $4                               # ＰＩＮ対応履歴データバックアップ
...
### ＰＩＮ受信ファイルからバックアップディレクトリ01にＰＩＮ対応履歴データをコピー
...
if ( $rc != 0 ) then
	...
	# 異常終了メッセージの出力
	$LOGWRITE "$MODULE" E "異常終了:$KINOU ＰＩＮ対応履歴データコピーエラー IMG-01 RC=[$rc]" "$USERKEY"
	exit 1
